  ...
  return (
    <div className='about'>
        ...
        <h3>ABOUT CHANDIGARH UNIVERSITY</h3>
          ...
          <p>Embark on a transformative educational journey with Chandigarh University's comprehensive education programs. Our cutting-edge curriculum is designed to empower students with the knowledge, skills, and experiences needed to excel in the dynamic field of education.</p>
